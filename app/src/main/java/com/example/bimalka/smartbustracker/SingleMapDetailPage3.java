...
public class SingleMapDetailPage3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_map_detail_page3);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng haldum = new LatLng(6.663088,80.669792);
        mMap.addMarker(new MarkerOptions().position(haldum).title("ToRathnapura").snippet("Location : Balangoda ").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_bus_icon)));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(haldum,10));

        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
                Intent intent=new Intent(SingleMapDetailPage3.this,BusDetailsPage.class);
