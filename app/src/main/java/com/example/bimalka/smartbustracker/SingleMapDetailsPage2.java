...
public class SingleMapDetailsPage2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_map_details_page2);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng haldum = new LatLng(6.76189,80.9087705);
        mMap.addMarker(new MarkerOptions().position(haldum).title("ToPanadura").snippet("Location : Beragala ").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_bus_icon)));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(haldum,10));

        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
                Intent intent=new Intent(SingleMapDetailsPage2.this,BusDetailsPage.class);
