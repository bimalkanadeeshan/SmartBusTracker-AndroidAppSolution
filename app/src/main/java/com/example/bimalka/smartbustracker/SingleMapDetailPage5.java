...
public class SingleMapDetailPage5 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_map_detail_page5);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng haldum = new LatLng(6.836542,80.9599636);
        mMap.addMarker(new MarkerOptions().position(haldum).title("ToBadulla").snippet("Location : Bandarawela ").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_bus_icon)));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(haldum,10));

        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
                Intent intent=new Intent(SingleMapDetailPage5.this,BusDetailsPage.class);
