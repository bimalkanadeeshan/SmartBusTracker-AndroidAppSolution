...
public class SingleMapDetailPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_map_detail_page);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng haldum = new LatLng(6.75922,80.880809);
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                Intent intent=new Intent(SingleMapDetailPage.this,BusDetailsPage.class);
