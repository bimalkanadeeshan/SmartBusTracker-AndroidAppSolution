...
public class SingleMapDetailPage4 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_map_detail_page4);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng haldum = new LatLng(6.6417578,80.4927914);
        mMap.addMarker(new MarkerOptions().position(haldum).title("ToBadulla").snippet("Location : Pelmadulla ").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_bus_icon)));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(haldum,10));

        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
                Intent intent=new Intent(SingleMapDetailPage4.this,BusDetailsPage.class);
